        ...
        >
            <View style={{ width: 300, alignItems: "center", justifyContent: "center" }}>
                ...
                <View style={{ paddingTop: 20, paddingBottom: 20, alignItems: "center" }}>
                    ...
                    <Text style={{ textAlign: "center", paddingBottom: 5, paddingTop: 5 }}>{error && error.title || ''}</Text>
                    <Text style={{ textAlign: "center", paddingBottom: 5, paddingTop: 5 }}>{error && error.body || ''}</Text>
                </View>
                <Button
                    title="Compris"
                    type="clear"
